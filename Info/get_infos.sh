...
3:measure_temp:temperature of processor SoC:
4:codec_enabled:enabled codec:H263 H264 MPG2 WVC1 MPG4 AGIF MJPA MJPB MJPG WMV9 MVC0
...
19:vcos log status:some system log status:
EOF
