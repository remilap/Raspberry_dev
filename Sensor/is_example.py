...
#####
# This is a custom 'getting started' script, made with care for remi.lapointe@gmail.com.
...
streamer = Streamer(bucket_name="Python Stream Example", bucket_key="python_example", access_key="TpxF1xIFECwXn4XuGsGYvHHAhLY1kJHU")
